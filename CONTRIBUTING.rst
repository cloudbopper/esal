...
esal could always use more documentation, whether as part of the
official esal docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `esal` repo on GitHub.
...
3. The pull request should work for Python 2.7, 3.4, 3.5 and 3.6, and for PyPy. Check
   https://travis-ci.org/cloudbopper/esal/pull_requests
